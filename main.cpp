...
void Dosar :: adaugare(Abonat a)
{
    abonati[l++] = a;
}

Abonat Dosar :: get_abonat(int poz)
{
    return abonati[poz];
}
...
{
    for(int i = 0; i < dosar.l; i++)
    {
        out << "Abonatul " << i + 1 <<":\n\n";
        Abonat a = dosar.get_abonat(i);
        out << a << '\n';
    }
    out << '\n';
    return out;
...
void meniu()
{
    ...
    cout << "Optiunea 0 - oprire program\n";*/
    int optiune;
    Dosar d;
    Abonat a;
    Abonat b;
